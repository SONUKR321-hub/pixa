...
import { UploadIcon, MagicWandIcon, PaletteIcon, SunIcon, LandscapeIcon } from './icons';
      ...
      <div className="flex flex-col items-center gap-6 animate-fade-in">
        ...
        <div className="mt-16 w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
                    <div className="flex items-center justify-center w-12 h-12 bg-gray-700 rounded-full mb-4">
                       <LandscapeIcon className="w-6 h-6 text-blue-400" />
                    </div>
                    <h3 className="text-xl font-bold text-gray-100">Replace Background</h3>
                    <p className="mt-2 text-gray-400">Instantly remove the background and replace it with anything you can imagine, from a tropical beach to outer space.</p>
                </div>
                <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
                    <div className="flex items-center justify-center w-12 h-12 bg-gray-700 rounded-full mb-4">
